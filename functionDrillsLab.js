...
function add(thingUno, thingDos){
  let numThingUno = Number(thingUno)
  let numThingDos = Number(thingDos)
  console.log(numThingUno + numThingDos)
}
add(44, 6)
add("144", 45)
...
console.log(bestMovie('The Jimmy Neutron Movie'))
